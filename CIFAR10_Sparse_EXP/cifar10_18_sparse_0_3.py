...
def get_args():
    ...
    parser.add_argument("--init_ckpt", type=str,default = "/home/madhu/.local/Processing-in-Interconnect-Codes/Trained_models/CIFAR10_sparse/ResNet18_cifar10_k_new43_sparse_review_03_p1.pt",
                        help="Checkpoint for model1 (TEMP init model)")
    parser.add_argument("--save_ckpt", type=str, default="/home/madhu/.local/Processing-in-Interconnect-Codes/Trained_models/CIFAR10_sparse/ResNet18_cifar10_k_new43_sparse_review_03_p2.pt",
