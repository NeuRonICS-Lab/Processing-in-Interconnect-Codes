...
class ResNet9_100_temp1(nn.Module):
    def __init__(self, in_channels, out=100,gamma=0,temp0 = False, temp1=False,temp2=False,temp3=False,temp4=False,temp5=False,temp6=False,temp7=False,temp8=False,sparse=False,drop=1):
        ...
        if(temp4):    
            self.c3 = temp_conv_k_opt(32*4, 64*4, kernel_size=3,gamma=gamma[4],diff=0,sparse=sparse,drop_prob = drop)#64*9
            self.conv3 = conv_block_Kr2(64*4, pool=True)
        else:
            print("5")
            self.conv3 = conv_block(32*4, 64*4, pool=True)
        ...
        if(temp5):
            self.c4 = temp_conv_k_opt(64*4, 128*4, kernel_size=3,gamma=gamma[5],diff=0,sparse=sparse,drop_prob = drop)#64*9
            self.conv4 = conv_block_Kr2(128*4, pool=True)
        else:
            print("6")
            self.conv4 = conv_block(64*4, 128*4, pool=True)
