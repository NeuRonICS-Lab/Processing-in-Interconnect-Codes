#!/usr/bin/env python3
"""
Train a TEMP / π² ResNet-18 on CIFAR-100 with knowledge distillation.
...
def get_args():
    parser = argparse.ArgumentParser(
        description="Train TEMP / π² ResNet-18 on CIFAR-100 with distillation"
    )

    parser.add_argument("--current_dir", type=str, required=True,
                        help="Project root directory (contains network_arch/, Datasets/)")
    parser.add_argument("--teacher_ckpt", type=str,default = "/home/madhu/.local/Processing-in-Interconnect-Codes/Trained_models/CIFAR100_sparse/ResNet18_cifar100_cutout_mlp_43.pt",help="Path to teacher ResNet-18 checkpoint")
    parser.add_argument("--init_ckpt", type=str,default = "/home/madhu/.local/Processing-in-Interconnect-Codes/Trained_models/CIFAR100_sparse/ResNet18_cifar100_k_p3.pt",
                        help="Checkpoint for model1 (TEMP init model)")
    parser.add_argument("--save_ckpt", type=str, default="/home/madhu/.local/Processing-in-Interconnect-Codes/Trained_models/CIFAR100_sparse/ResNet18_cifar100_k_p41.pt",
...
def main():
    ...
    from resnet_18 import ResNet18, ResNet18_TEMPs
    ...
    train_set = CIFAR100(data_dir, train=True, download=True, transform=train_transform)
    test_set = CIFAR100(data_dir, train=False, download=True, transform=test_transform)
    ...
    K_in = [1, 0.3, 0.3, 0.3, 0.3, 0.3]
    # Final TEMP / π² student
    model = ResNet18_TEMPs(
        num_classes=100,
        K_act=gamma,
        K_in=K_in,
