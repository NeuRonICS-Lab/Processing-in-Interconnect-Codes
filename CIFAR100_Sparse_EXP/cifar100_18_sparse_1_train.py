...
def get_args():
    ...
    parser.add_argument("--init_ckpt", type=str,default = "/home/madhu/.local/Processing-in-Interconnect-Codes/Trained_models/CIFAR100_sparse/ResNet18_cifar100_k_1_p3.pt",
                        help="Checkpoint for model1 (TEMP init model)")
    parser.add_argument("--save_ckpt", type=str, default="/home/madhu/.local/Processing-in-Interconnect-Codes/Trained_models/CIFAR100_sparse/ResNet18_cifar100_k_1_p41.pt",
