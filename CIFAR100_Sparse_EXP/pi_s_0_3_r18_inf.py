#!/usr/bin/env python3
"""
Evaluate TEMP / π² ResNet-18 on CIFAR-10 using Lightning Fabric.
...
from resnet_18 import ResNet18_TEMPs
...
def main():
    ...
    # Model configuration
    # ─────────────────────────────
    K_act = [16,50,100,100,200,50]
    K_in  = [1, 0.3, 0.3, 0.3, 0.3, 0.3]  # input sparsity (for TEMP-s)
    ...
    # ckpt_path = "/data/madhu/CIFAR100/ResNet18/ResNet18_cifar100_k_p4.pt"
