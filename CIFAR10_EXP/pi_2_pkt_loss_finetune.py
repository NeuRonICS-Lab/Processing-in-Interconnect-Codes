...
from resnet_9 import ResNet9_100_temp1,ResNet9_100_temp_noise
...
def main():
    ...
    student = ResNet9_100_temp_noise(3, out=10, gamma=gamma,
                          temp0=True, temp1=True, temp2=True, temp3=True,
                          temp4=True, temp5=True, temp6=True, temp7=True, temp8=True,sparse=True,drop=0.9).to(fabric.device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if acc > accmax:
            accmax = acc
            torch.save(student.state_dict(), os.path.join(results_dir, "CIFAR10", "ResNet9_cifar10_k_pkt_loss.pt"))
