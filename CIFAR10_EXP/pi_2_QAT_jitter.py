...
def main():
    ...
    student = ResNet9_100_temp_noise(3, out=10, gamma=gamma,std=0.1,
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if acc > accmax:
            accmax = acc
            torch.save(student.state_dict(), os.path.join(results_dir, "CIFAR10", "ResNet9_cifar10_k_qat_jitter.pt"))
