...
parser.add_argument("--device_ids", type=int, nargs='+', default=[0,1,2,3], help="CUDA device IDs")
...
from resnet_9 import ResNet9_100, ResNet9_100_temp1
...
def main():
    ...
    # Models
    student = ResNet9_100_temp1(in_channels=3, out=10, gamma=args.gamma,
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if acc > best_acc:
            best_acc = acc
            # torch.save(student.state_dict(), os.path.join(results_dir, "CIFAR100", "ResNet9_cifar100_k_new.pt"))
