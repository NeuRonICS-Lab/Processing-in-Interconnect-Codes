...
print(layer_dir)
from TEMP_CONV_in import temp_conv_k_opt1single,temp_conv_k_opt1s
from TEMP_FC_in import MPLayer_in_Ksingle,MPLayer_in_Ks
...
def ResNet18_TEMP(temp1=False,temp2=False,temp3=False,temp4=False,temp5=False,temp6=False,K_in=1,K_act=1,num_classes=10):
    return ResNet_TEMP(BasicBlock_TEMP, [2, 2, 2, 2],temp1=temp1,temp2=temp2,temp3=temp3,temp4=temp4,temp5=temp5,temp6=temp6,K_in=K_in,K_act=K_act,num_classes=num_classes)
